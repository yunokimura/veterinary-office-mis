...
<head>
    ...
    <title>Verify Email - Dasmariñas City Veterinary Services</title>
    ...
    <main class="py-10">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-gray-600">We've sent a 6-digit code to</p>
                <p class="font-semibold text-primary">{{ session('email') }}</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                ...
                <div class="mt-6 text-center">
                    ...
                    <a href="{{ route('otp.resend') }}" id="resendLink" class="text-primary hover:text-primary-light font-semibold">Resend Code</a>
    ...
    <script>
        ...
        const interval = setInterval(() => {
            ...
            if (countdown <= 0) {
                ...
                document.querySelector('.text-gray-500').textContent = 'You can now resend the code';
            }
        }, 1000);
        ...
        // Check for OTP sent message (after registration)
        @if(session('otp_sent'))
            Swal.fire({
                icon: 'success',
                title: 'OTP Sent!',
