...
@section('title', 'New Business Profile')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-plus-circle me-2"></i>New Business Profile</h2>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('admin-asst.business-profiles.store') }}">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="Enter business name">
                            @error('name')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                    ...
                                    <option value="poultry" {{ old('type') == 'poultry' ? 'selected' : '' }}>🐔 Poultry Farm</option>
                                    ...
                                    <option value="vet_clinic" {{ old('type') == 'vet_clinic' ? 'selected' : '' }}>🏥 Veterinary Clinic</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="permit_no" class="form-control" value="{{ old('permit_no') }}" placeholder="Auto-generated if empty">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="capacity" class="form-control" value="{{ old('capacity') }}" placeholder="e.g., 500 heads">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Operations Start Date</label>
                                <input type="date" name="operations_start" class="form-control" value="{{ old('operations_start') }}">
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="owner_name" class="form-control @error('owner_name') is-invalid @enderror" value="{{ old('owner_name') }}" required placeholder="Enter owner name">
                            @error('owner_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="owner_email" class="form-control" value="{{ old('owner_email') }}" placeholder="owner@example.com">
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('admin-asst.business-profiles.index') }}" class="btn btn-secondary">Cancel</a>
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>Create Business Profile
                    </button>
                </div>
            </form>
        </div>
